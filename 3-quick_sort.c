...
void quick_sort(int *array, size_t size)
{
	...
	quicksort_recursive(array, low, high, size);
}

/**
 * quicksort_recursive - sorts array using low / high positions
 * @array: list of numbers
...
/**
 * lomuto_partition - sections an array using Lomuto quick_sort algo
